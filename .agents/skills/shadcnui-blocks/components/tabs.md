# Tabs (shadcnui-blocks)

Scraped from [shadcnui-blocks.com/components/tabs](https://www.shadcnui-blocks.com/components/tabs).
18 variant(s). Install base UI with `pnpm dlx shadcn@latest add tabs` when `registryDependencies` includes it.

## Variants index

| ID | Title | Notes |
| --- | --- | --- |
| `tabs-01` | Default Tabs | Default tabs component |
| `tabs-02` | Underlined Tabs | Tabs with underlined style |
| `tabs-03` | Separated Tabs | Tabs with separated style |
| `tabs-04` | Bordered Tabs | Tabs with bordered style |
| `tabs-05` | Box Tabs | Tabs with box style |
| `tabs-06` | Bootstrap Tabs | Tabs with bootstrap style |
| `tabs-07` | Icon Tabs | Tabs with icons |
| `tabs-08` | Mobile Navigation Tabs | Tabs designed for mobile navigation |
| `tabs-09` | Tabs with Badge | Tabs with badge indicators |
| `tabs-10` | Sharp Tabs | Tabs with sharp corners |
| `tabs-11` | Shadow Tabs | Tabs with shadow effect |
| `tabs-12` | Skewed Tabs | Tabs with skewed shape |
| `tabs-13` | Vertical Tabs | Tabs with vertical orientation |
| `tabs-14` | Vertical Left Bordered Tabs | Vertical tabs with left border |
| `tabs-15` | Vertical Separated Tabs | Vertical tabs with separated style |
| `tabs-16` | Vertical Sharp Tabs | Vertical tabs with sharp corners |
| `tabs-17` | Vertical Bordered Tabs | Vertical tabs with borders |
| `tabs-18` | Animated Tabs | Tabs with content animation |

## Variant source

### Default Tabs (`tabs-01`)
...
### Mobile Navigation Tabs (`tabs-08`)
...
### Vertical Left Bordered Tabs (`tabs-14`)
...
### Vertical Separated Tabs (`tabs-15`)
...
### Vertical Bordered Tabs (`tabs-17`)
