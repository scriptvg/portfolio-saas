...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col gap-1.5 border-b border-border/60 px-5 py-4 text-left",
        className
      )}
      {...props}
    />
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "mt-auto flex shrink-0 flex-row items-center justify-end gap-2 border-t border-border/60 bg-muted/30 px-5 py-3",
        className
      )}
      {...props}
    />
